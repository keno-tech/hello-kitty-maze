...
// Create an invisible static physics object for the ground (just for collision detection)
ground.create(400, 500, null).setSize(800, 20); // Adjust the Y position and size as needed
