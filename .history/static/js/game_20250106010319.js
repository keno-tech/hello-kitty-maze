...
function preload() {
    ...
    this.load.image('ground', '/path/to/ground/image.png');
...
function create() {
    ...
    ground.create(400, 392, 'ground').setScale(2, 0.1).refreshBody(); // Position the ground just below the line
...
function spawnObstacle() {
    ...
    let obstacle;
    if (obstacleType === 0) {
        obstacle = obstacles.create(x, y, 'obstacle').setScale(0.5);
    } else {
        obstacle = obstacles.create(x, y, 'question-mark').setScale(0.5);
    }
