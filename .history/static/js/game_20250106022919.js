...
// Create an invisible collision object for the ground
ground = this.physics.add.staticGroup();

// Optionally, you can create a visual rectangle (transparent) to represent the ground
ground.create(400, 495, 'transparent').setSize(800, 10); // Use a 'transparent' sprite if needed
