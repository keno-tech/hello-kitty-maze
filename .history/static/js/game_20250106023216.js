...
function create() {
    ...
    ground.create(400, 495, null).setSize(800, 10); // Move collision detection down by adjusting Y and size
...
function showLeaderboardForm() {
    ...
    leaderboardDiv.innerHTML = `
        ...
        <button id="replay-button" style="margin-top: 10px;">Replay</button>
    `;
