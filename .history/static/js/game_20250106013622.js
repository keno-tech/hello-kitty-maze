...
function endGame() {
    ...
    this.physics.world.isPaused = true;  // Pause the physics world
    player.setTint(0xff0000);  // Optional: Set player color to red

    setTimeout(() => {
        showLeaderboardForm();  // Show leaderboard form after a short delay
    }, 1000);
}

// Somewhere in your game loop or collision handling:
initialize.handleCollision = (function (self) {
    return function () {
        endGame.call(self);  // Use .call() to ensure 'this' is the Phaser scene
    };
})(initialize);
...
function showLeaderboardForm() {
    ...
    document.getElementById('leaderboard-form').addEventListener('submit', function (e) {
        ...
        .then((data) => {
            ...
            // Redirect to leaderboard page or display the leaderboard here
