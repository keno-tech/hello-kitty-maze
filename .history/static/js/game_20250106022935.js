...
// Create a static group for the ground
ground = this.physics.add.staticGroup();

// Create a static body for collision but without a sprite
const groundCollision = ground.create(400, 495);
groundCollision.setSize(800, 10);  // Set the size for collision detection
